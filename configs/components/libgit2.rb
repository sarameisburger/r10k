...
#
#
#  In the current project libgit2 is bundled with rugged, so this isn't used.
#  This is only here as an example of how we might package it in the future if
#  we need to outside of rugged
#
